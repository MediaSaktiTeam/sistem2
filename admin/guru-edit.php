...
<?php
$id = $_GET['id'];
$query = mysql_query("select * from tbl_guru where kode_guru='$id'") or die(mysql_error());
...
<div align="center"><span class="style2"> EDIT DATA GURU </span></div>
<br />
  ...
  <tr>
    <td><form method="post" enctype="multipart/form-data" name="upload" id="upload">
      ...
      <input type="hidden" name="id" value="<?php echo $id; ?>" />
          ...
          <td width="83%"><input value="<?php echo $data['nama_guru']; ?>" name="nama_guru" type="text" id="nama_guru" size="40" style="background-color:#CCCCCC"/></td>
        </tr>    
     ...
     <tr>
      ...
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['jurusan'] ; ?>" name="jurusan" type="text" id="jurusan"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>

     <tr>
      <td width="17%"><div align="Left"><strong>Tempat Lahir</strong></div></td>          
      <td width="83%" style="color:#FFFFFF"><input value="<?php  echo $data['tempat_lahir']; ?>" name="tempat_lahir" type="text" id="tempat_lahir"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>
     ...
     <tr>
      ...
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['umur'] ; ?>" name="umur" type="text" id="umur"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>

     <tr>
      <td width="17%"><div align="Left"><strong>NIP</strong></div></td>          
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['nip'] ; ?>" name="nip" type="text" id="nip"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>

     <tr>
      <td width="17%"><div align="Left"><strong>NUPTK</strong></div></td>          
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['nuptk'] ; ?>" name="nuptk" type="text" id="nuptk"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>

     <tr>
      <td width="17%"><div align="Left"><strong>Golongan</strong></div></td>          
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['gol'] ; ?>" name="gol" type="text" id="gol"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>

     <tr>
      <td width="17%"><div align="Left"><strong>Tugas Mengajar</strong></div></td>          
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['tgs_mengajar'] ; ?>" name="tgs_mengajar" type="text" id="tgs_mengajar"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>

     <tr>
      <td width="17%"><div align="Left"><strong>Tugas Tambahan</strong></div></td>          
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['tgs_tambahan'] ; ?>" name="tgs_tambahan" type="text" id="tgs_tambahan"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>

      <tr>
      <td width="17%"><div align="Left"><strong>Tahun Sertifikasi</strong></div></td>          
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['thn_sertifikasi'] ; ?>"  name="thn_sertifikasi" type="text" id="thn_sertifikasi"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>
     ...
     <tr>
      ...
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['no_hp'] ; ?>" name="no_hp" type="text" id="no_hp"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>

      <tr>
      <td width="17%"><div align="Left"><strong>SK CPNS</strong></div></td>          
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['sk_cpns'] ; ?>" name="sk_cpns" type="text" id="sk_cpns"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>
     ...
     <tr>
      ...
      <td width="83%" style="color:#FFFFFF"><input value="<?php echo $data['sk_pns'] ; ?>" name="sk_pns" type="text" id="sk_pns"  size="10" style="background-color:#CCCCCC"/>
      </td>
     </tr>
...
$add=mysql_query("update tbl_guru set nama_guru='$nama_guru', jenis_kelamin='$jenis_kelamin', agama='$agama', pend_terakhir='$pend_terakhir', jurusan='$jurusan', tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', umur='$umur', nip='$nip', nuptk='$nuptk', gol='$gol', tgs_mengajar='$tgs_mengajar', tgs_tambahan='$tgs_tambahan', thn_sertifikasi='$thn_sertifikasi', stat_kepegawaian='$stat_kepegawaian', no_hp='$no_hp', sk_cpns='$sk_cpns', tmt_cpns='$tmt_cpns', sk_pns='$sk_pns', tmt_pns='$tmt_pns', tmt_guru='$tmt_guru', tmt_disekolah='$tmt_disekolah', stat_kepegawaian='$stat_kepegawaian', nm_sekolah='$nm_sekolah', gambar='$fileName' where kode_guru='$id' "); 
move_uploaded_file($_FILES['gambar']['tmp_name'], "img/".$_FILES['gambar']['name']);
}  
if ($add) {
