...
<div align="center"><span class="style2"> INPUT JURUSAN </span></div>
<br />
  ...
  <tr>
    <td><form method="post" enctype="multipart/form-data" name="upload" id="upload">
      ...
      <input type="hidden" name="id" value="<?php echo $id; ?>" />
          ...
          <td width="83%"><input name="nm_jurusan" type="text" id="nm_jurusan" size="40" style="background-color:#CCCCCC"/></td>
        </tr>   
...
$add=mysql_query("INSERT INTO  tbl_jurusan (nm_jurusan) values ('$nm_jurusan' )"); 
}  
if ($add) {
